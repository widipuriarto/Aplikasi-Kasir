...
public class FormSupplier extends javax.swing.JFrame {
     ...
     */
    public FormSupplier(String namaUser, int idUserLogin, String role) {
        setTitle("Form Supplier List");
        initComponents();
    ...
    private void CariData(){
        try {
            st = conn.createStatement();
            rs = st.executeQuery("SELECT * FROM supplier WHERE namaSupplier"
    ...
    private void initComponents() {
        ...
        tblItemList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Supplier ID", "Supplier Name", "Address", "Telephone"
            }
        ));
